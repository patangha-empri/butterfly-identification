...
// (and the keystore it points to) is git-ignored and created by the developer —
// see the Phase 14 release notes. Without it, release builds fall back to the
// debug key so `flutter build` still works locally.
...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.thardeye.butterfly_india"
    ...
    buildTypes {
        release {
            ...
            // back to debug signing so local release builds still succeed.
